...
<body>
        ...
        <div class="">
            ...
            <div class="row">
                <div class="galUno col-sm-12 col-md-6 col-lg-3  align-items-center justify-content-center">
                    <img src="Pareja/1.jpeg" onclick="abrirContenido();fotoActual(1)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3  align-items-center justify-content-center">
                    <img src="Pareja/2.jpeg" onclick="abrirContenido();fotoActual(2)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/3.jpeg" onclick="abrirContenido();fotoActual(3)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/4.jpeg" onclick="abrirContenido();fotoActual(4)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/5.JPG" onclick="abrirContenido();fotoActual(5)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/6.jpeg" onclick="abrirContenido();fotoActual(6)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/7.JPG" onclick="abrirContenido();fotoActual(7)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/8.jpeg" onclick="abrirContenido();fotoActual(8)" class="fotoGaleria">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/9.jpeg" onclick=" abrirContenido();fotoActual(9) " class="fotoGaleria ">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center ">
                    <img src="Pareja/10.jpeg" onclick=" abrirContenido();fotoActual(10) " class="fotoGaleria ">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center">
                    <img src="Pareja/11.JPG" onclick=" abrirContenido();fotoActual(11) " class="fotoGaleria ">
                </div>

                <div class="galUno col-sm-12 col-md-6 col-lg-3 align-items-center justify-content-center ">
                    <img src="Pareja/12.jpeg" onclick=" abrirContenido();fotoActual(12) " class="fotoGaleria ">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="miContenido" class="contenido">
        ...
        <div class="contenidoFotoHorizontal">

            <div class="misFotos">
                <div class="numeroDeFoto">1 / 12</div>
                <img class="imgJS" src="Pareja/1.jpeg">
            </div>

            <div class="misFotos">
                <div class="numeroDeFoto">2 / 12</div>
                <img class="imgJS" src="Pareja/2.jpeg" />
            </div>

            <div class="misFotos">
                <div class="numeroDeFoto">3 / 12</div>
                <img class="imgJS" src="Pareja/3.jpeg" />
            </div>

            <div class="misFotos">
                <div class="numeroDeFoto">4 / 12</div>
                <img class="imgJS" src="Pareja/4.jpeg" />
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">5 / 12</div>
                <img class="imgJS " src="Pareja/5.JPG">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">6 / 12</div>
                <img class="imgJS " src="Pareja/6.jpeg">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">7 / 12</div>
                <img class="imgJS " src="Pareja/7.JPG">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">8 / 12</div>
                <img class="imgJS " src="Pareja/8.jpeg">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">9 / 12</div>
                <img class="imgJS " src="Pareja/9.jpeg">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">10 / 12</div>
                <img class="imgJS " src="Pareja/10.jpeg">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">11 / 12</div>
                <img class="imgJS " src="Pareja/11.JPG">
            </div>

            <div class="misFotos ">
                <div class="numeroDeFoto">12 / 12</div>
                <img class="imgJS " src="Pareja/12.jpeg">
            </div>
