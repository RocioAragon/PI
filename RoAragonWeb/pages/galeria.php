...
<body>
    ...
    <div class="m-auto w-80">
        <div class="galeria row">
            <div class="galUno col-sm-12 colmd-6 col-lg-4 align-items-center justify-content-center">
                <div class="card" style="width: 21rem;">
                    <img src="imagesGal/1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Familia</h5>
                        <p class="card-text">Fotos de familia, amigos, en esta galería encontrarás fotos entrañables.</p>
                        <a href="galeria1.php" class="btn btn-dark">Ver galería</a>
                    </div>
                </div>
            </div>
            <div class="galUno col-sm-12 colmd-6 col-lg-4">
                <div class="card" style="width: 21rem;">
                    <img src="imagesGal/2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Pareja</h5>
                        <p class="card-text">Fotos de pareja, individuales, en esta galería encontrarás fotos llenas de amor.</p>
                        <a href="galeria2.php" class="btn btn-dark">Ver galería</a>
                    </div>
                </div>
            </div href=" ">
            <div class="galUno col-sm-12 colmd-6 col-lg-4">
                <div class="card" style="width: 21rem;">
                    <img src="imagesGal/3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Retrato</h5>
                        <p class="card-text">Galería de retratos, esta galería encontrarás retratos llenos de luz.</p>
                        <a href="galeria3.php" class="btn btn-dark">Ver galería</a>
                    </div>
                </div>
            </div>
        </div>
