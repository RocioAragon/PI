...
<head>
  ...
  <body>
    ...
    <h2 color="blue" class="text-center">Inserción Entrada</h2>
    <br>
        <form class='m-auto w-25' action="insertarEntrada.php" method="post" class="form">
                   
            <div class='form-group row'>
                    <label for='titulo' class='col-sm-2 col-form-label'><b>Título</b></label>
                    <div class='col-sm-10'>
                        <input class='form-control' id="titulo" class="titulo" type="text" name="titulo" size="36" rows="10" cols="40" placeholder="" maxlength="100" required/>
                    </div>
            </div>
            ...
            <div class='form-group row'>
                    ...
                    <div class='col-sm-10'>
                        <textarea class='form-control' id="noticia" class="noticia" name="noticia" rows="4" cols="40" class="input" placeholder="" maxlength="1000" required/> </textarea>
                    </div>
            </div>
            ...
            <div class='form-group row'>
                    ...
                    <div class='col-sm-10'>
                        <input class='form-control' id="foto" class="foto" type="text" name="foto" size="36" rows="10" cols="40" placeholder="" maxlength="100" required />                        </div>
                    </div>
            </div>

            <br>
            <input class="btn btn-dark" type="submit" value="Insertar Entrada" />
        </form>
        <br>
        <br>
