...
<head>
  ...
  <body>
    ...
    </nav><nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        <div class="container-fluid">
            <img src="../img/RoAragon.png" alt="" width="199" height="89">
            <br>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
...
//Función para validar formulario.
 function validarFormulario($titulo, $noticia){
    ...
    if(!isset($titulo) || $titulo == "" ){
        $esValido=false;
        echo "<li> <h1>Se requiere un titulo para la noticia.</h1></li>";
    }//FinSi

    //Comprobamos si la noticia está seteada o si es cadena vacía.
    if($noticia == "" ){
        $esValido=false;
        echo "<li><h1> Se requiere un texto para la noticia.</h1></li>";
    }//FinSi
...
function errorInsercion(){
    echo "<h1  align=\"center\"> No se ha podido realizar la actualización.</h1>";
}//FinFuncion  

 //Función para insertar.
 if(validarFormulario($titulo, $noticia)){
    $sql = "UPDATE entradas set titulo='$titulo', contenido='$noticia', foto='$foto' where id='$id'";
}
...
if (mysqli_query($conn, $sql)) {
    ...
    <br>
    <br>';
    echo "<h1 align=\"center\"> Noticia actualizada.</h1>";
} else {
    errorInsercion();
...
<a class="" style="color:white" href="interfazAdministrarEntradas.php"><button class="btn btn-dark">Volver a panel de control</button></a>
</div>
<br>
<br>
<br>
