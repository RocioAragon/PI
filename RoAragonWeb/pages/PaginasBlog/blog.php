...
<?php
  ...
  //Consulta para usar nuestra BBDD
  $sql = "USE roaragonweb";
  ...
  if ($result = mysqli_query($conn, $consulta)) {
    while ($row = mysqli_fetch_row($result)) {
        echo "<div class=\"m-auto w-75 \">";
            echo "<hr class=\"featurette-divider\">";

            echo "<div class=\"row featurette\">";
                echo "<div class=\"col-md-7\">";
                    echo "<h2 class=\"featurette-heading\">". $row[1] ."</h2>";
                    echo "<br>";
                    echo "<p class=\"lead\">" . $row[2] . "</p>";
                echo "</div>";
                echo "<div class=\"col-md-5\">";
                    echo "<img class=\"bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto\" width=\"500\" height=\"500\" src=\"imagenesBlog/". $row[3] ."\">";
                echo "</div>";
            echo "</div>";
        echo "</div>";  
    }
