...
<head>
  ...
  //Algoritmo/Imprimir Noticia
  $consulta = "SELECT * FROM entradas";

 echo "<h2 align=\"center\">Panel de control de entradas</h2>";
 echo "<br>";
 echo "<div align=\"center\" class=\"m-auto w-95\">";
 echo "<a href='formularioInsercionEntrada.php' class=\"btn btn-dark\"> Insertar Noticia</a>";
 echo "<br>";
 echo "<br>";
 echo "<table class='m-auto w-75 table'> <thead class=\"thead-dark\"><tr> <th>Título</th> <th>Contenido</th> <th>Foto</th> <th></th><th></th><th></th><th></th><th></th></tr></thead>";
 if ($result = mysqli_query($conn, $consulta)) {
    while ($row = mysqli_fetch_row($result)) {
        echo "<tr>";
            echo "<td><b>".$row[1]."</b></td>";
            echo "<td>".$row[2]."</td>";
            echo "<td><img class=\"bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto\" width=\"500\" height=\"500\" src=\"imagenesBlog/". $row[3] ."\"></td>";
            echo"</td><td><form action='interfazEditarEntradas.php' method='post'>";
            echo "<input type='text' id='id' name='id' value='". $row[0] ."' hidden>";
            echo "<input type='text' id='titulo' name='titulo' value='". $row[1] ."' hidden>";
            echo "<input type='text' id='contenido' name='contenido' value='". $row[2] ."' hidden>";
            echo "<input type='text' id='foto' name='foto' value='". $row[3] ."' hidden>";
            echo "<input class=\"btn btn-dark\" type='submit'value='Editar'></form>"."<td><td><form action='eliminarEntrada.php'method='post'><input type='text' name='id' value=". $row[0] ." hidden><input class=\"btn btn-dark\" type='submit' value='Eliminar'></form></td></tr>";
            echo "</tr>";
    }
