...
<body>
    ...
    <br>
    <br>
    <div class="row featurette justify-content-center" name="new" id="new">
        <div class="col-md-5">
            <h2 class="featurette-heading">Rocío Aragón. <br><span class="text-muted">Fotógrafa & Full Stack Web Developer.</span></h2>
            <br>
            <p class="lead">¡Hola! Bienvenidos a mi web.</p>
            Siempre he sido una apasionada en capturar momentos y escenas de mi vida. Para mí no hay herencia más bonita que los recuerdos, aquellos que te hacen revivir emociones pasadas y hacerlas presentes.
            <br>Creo en las energías, en el amor, en el poder de las emociones, y es justo lo que busco transmitir a través de mis fotografías. <br><br>El amor desde la perspectiva y experiencia humana, la diversidad y lo genuino de los sentimientos.
            <br>La simplicidad, espontaneidad y esencia es lo que definen mi estilo.
            <br>Me inspiran los libros, el cine, la poesía, el minimalismo, las plantas, la música. <br><br>Creo que los detalles hacen la diferencia y que menos es más.
            <br>
            <br>
            <img src="../img/firma.png" class="firma" />
        </div>
        <br>
        <div class="col-md-4">
            <img src="../img/ro.JPG" class="bd-placeholder-img card-img-top img-fluid" width="400" height="500"></img>
        </div>
    </div>
    <br>
    <br>
