    ...
    <div class="container">
        ...
        <div class="container">
            ...
            if (mysqli_connect_errno()) {
					...
					if(isset($_POST['dniB'])){
						$dniBuscado = $_POST['dniB'];
					} else {
						$dniBuscado = $_SESSION['dni'];
					}
					
					$consulta = "SELECT * FROM usuarios where dni='$dniBuscado'";
                    ...
                    if ($result = mysqli_query($conn, $consulta)) {                   // Salida por pantalla
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<form class='m-auto w-75' action='editarUsuario.php' method='post'>
                            <br>";
                            echo "<p  class='text-center'>Edite los datos que desee:</p>
                            <br>";
							echo "
                            <div class='form-group row'>
                                <label for='dni' class='col-sm-2 col-form-label'><b>DNI</b></label>
                                <div class='col-sm-10'>
                                    <input class='form-control' type='text' id='dni' name='dni' placeholder='' value=" . $dniBuscado . " required>
                                </div>
                            </div>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class='col-sm-10'>
                                    <input class='form-control' type='text' id='nombre' name='nombre' placeholder='' value=". $row['nombre'] . " required>
                                </div>
                            </div>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class='col-sm-10'>
                                    <input class='form-control' type='text' id='apellidos' name='apellidos' placeholder='' value=" . $row['apellidos'] . " required>
                                </div>
                            </div>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class='col-sm-10'>
                                    <input class='form-control' type='text' id='contraseña' name='contraseña' placeholder=''  value=" . $row['contrasenia'] . " required>
                                </div>
                            </div>";
                                ...
                                <div class='col-sm-2'><b>Administrador</b> </div>
                                    <div class='col-sm-10'>
                                        <div class='form-check'>
                                            <input class='form-check-input' type='checkbox' id='administrador' name='administrador' " . $esAdmin . ">
                            ...
                            if(isset($_POST['dniB'])){
                                ...
                                <div class='col-sm-2'><b>Activación</b> </div>
                                    <div class='col-sm-10'>
                                        <div class='form-check'>
                                            <input class='form-check-input' type='checkbox' id='activado' name='activado' " . $activo . ">
							...
							echo "
							<tr>
								<input type='text' id='dniAntiguo' name='dniAntiguo' value=" . $dniBuscado . " hidden>
								<td colspan='2'><br/><input type='submit' class='btn btn-dark' value='Registrar cambios'></td>
								</form>
							</tr>";
							if($admin){
								echo "</table>
								...
								<form action='../../index.php'>
									<input type='submit' class='btn btn-dark' value='Salir' />
								</form>";
							}
                        }
                    }
