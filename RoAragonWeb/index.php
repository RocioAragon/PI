            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link text-dark" href="pages/galeria.php">Galería</a>
                        <a class="nav-link text-dark" href="pages/Tienda.php">Tienda</a>
                        <a class="nav-link text-dark" href="pages/PaginasBlog/blog.php">Blog</a>
                        <a class="nav-link text-dark" href="pages/sobremi.php">Sobre Mí</a>
                        <a class="nav-link text-dark" href="pages/contacto.php">Contacto</a>
                        <a class="nav-link " href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        <a class="nav-link " href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        <a class="nav-link " href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        <a class="nav-link " href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                                    ...
                                    if (isset($_SESSION['sesion_iniciada'])) {
                                        ...
                                        if ($admin) {
                                            echo "<div >
                                                ...
                                                <ul class='text-start'>
                                                <li><a href='pages/PaginasUsuarios/administrarUsuarios.php'>Gestión de usuarios</a></li>
                                                <li><a href='pages/PaginasBlog/interfazAdministrarEntradas.php'>Entradas Blog</a></li>
                                                <li><a href='pages/PaginasPedidos/verPedidos.php'>Ver pedidos</a></li>
                                                <li><a href='pages/PaginasPedidos/controlPedidos.php'>Control de pedidos</a></li>
                                                </ul></div>";
                                        } else {
                                            echo "<div >
                                                <h5>Panel de Usuario</h5>
                                                <ul class='text-start'>
                                                <li><a href='pages/PaginasUsuarios/interfazEditarUsuario.php'>Editar usuario</a></li>
                                                <li><a href='pages/PaginasPedidos/verPedidos.php'>Compras realizadas</a></li>
                                                </ul></div>";
                                        }
                                        echo "<form action='index.php' method='post'>"."
        ...
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="img/1.jpeg" class="d-block w-100" id="imagenCarrusel" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="img/2.jpeg" class="d-block w-100" id="imagenCarrusel" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="img/3.JPG" class="d-block w-100" id="imagenCarrusel" alt="...">
                </div>

                <div class="carousel-item">
                    <img src="img/4.JPG" class="d-block w-100" id="imagenCarrusel" alt="...">
                </div>
            </div>

            <button id="btn1" class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval"
                data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button id="btn2" class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval"
                data-bs-slide="next">
